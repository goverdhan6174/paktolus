...
try {
  ...
  // --------------------REMOVE START---------------------
  const token = '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';
  const repo = 'paktolus';
  const owner = 'goverdhan6174';
  const baseSha = 'fc95ae51816ca2a4999f6bbbbd06d27f931bc74f';
  // --------------------REMOVE END------------------------
  ...
  // --------------------REMOVE START---------------------
  core.info(`owner: ${owner} and repo: ${repo}`);
  // --------------------REMOVE END------------------------
  ...
  octokit
    .request(
      // --------------------REMOVE START---------------------
      'GET https://api.github.com/repos/:owner/:repo/contents/package.json?ref=paktolus-package-update',
      // --------------------REMOVE END------------------------
      // `GET ${baseUrl}`
      {
        owner,
